    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('medicaments.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" id="dateExpiration" name="dateExpiration" value="{{ old('dateExpiration') }}" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="fabricant" name="fabricant" value="{{ old('fabricant') }}" class="form-control" required>
                @error('fabricant')
                    <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            </div>
